    ...
    <form action="/admin/louvor" method="POST" enctype="multipart/form-data">
        <div class="form-group">
            @csrf
                ...
                <div class="form-group">
                  <label for="exampleFormControlInput1">Nomes das Lideres</label>
                  <input type="text" class="form-control" id="exampleFormControlInput1" name="title" placeholder="Nome das Lideres" required="campo obrigatorio">
                </div>
